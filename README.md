...
- [3. Création du rapport temporel](#3-création-du-rapport-temporel)
- [4. Création du dashboard SOC](#4-création-du-dashboard-soc)
- [5. Dashboard final](#5-dashboard-final)
- [6. Création de l'alerte](#6-création-de-lalerte)
...
[![Top 10 IPs — 404 Errors](1.png)](1.png)

> ⚠️ L'IP `87.194.216.51` est en tête avec **40 erreurs 404** sur l'ensemble des logs — confirmant qu'elle reste la plus suspecte de l'ensemble du trafic.

On sauvegarde ce rapport via **Save As > Report** avec le titre **Top 10 IPs — 404 Errors**.

[![Sauvegarde du rapport dans le dashboard](6.png)](6.png)

---

## 3. Création du rapport temporel
...
[![Évolution des erreurs 404 sur 7 jours](2.png)](2.png)
...
On sauvegarde ce rapport avec le titre **404 Errors Evolution — 7 Days**.

---

## 4. Création du dashboard SOC

Une fois les rapports créés, on construit le dashboard en cliquant sur **Add to Dashboard > New Dashboard**.

[![Création du nouveau dashboard](4.png)](4.png)
...
On ajoute ensuite un troisième panneau avec la distribution de tous les status codes :
...
Ce panneau donne une vue globale du trafic — essentiel pour contextualiser les erreurs 404 par rapport au volume total.
...
[![Dashboard SOC — Vue complète](3.png)](3.png)
...
> 💡 **Ce dashboard permet à un analyste SOC de surveiller la reconnaissance web en temps réel sans lancer manuellement la moindre recherche.** Il suffit d'ouvrir le dashboard pour avoir une vue complète de la situation.

[![Vue du rapport depuis l'onglet Reports](5.png)](5.png)
...
Dans Splunk : **Alerts > New Alert** ou depuis la recherche : **Save As > Alert**
